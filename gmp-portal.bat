@echo off
REM ===================================================================
REM FSQTAR Guest Management Portal (GMP) - Official System Launcher
REM Auto-detects IIS vs Local Dev, starts Backend API & Frontend, and
REM opens the portal in your default browser.
REM ===================================================================

title GMP Portal - Guest Management System
color 0A
cd /d "%~dp0"

echo ===================================================================
echo   FSQTAR Guest Management Portal (GMP) - Launcher
echo ===================================================================
echo.
...
echo ===================================================================
echo   GMP Portal is running successfully!
echo ===================================================================
echo.
pause
